    ...
    try:
        ...
        <div style="border: 2px solid #4285F4; border-radius: 8px; padding: 16px; margin: 10px 0; background: #f8fafd; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
            ...
            <ol style="margin: 0 0 12px 0; padding-left: 20px; color: #3c4043;">
                <li>Open <a href="https://colab.research.google.com" target="_blank" rel="noopener noreferrer" aria-label="Open Google Colab" style="color: #1a73e8; font-weight: bold;">Google Colab</a> in Safari or Chrome.</li>
            ...
            <a href="https://colab.research.google.com" target="_blank" rel="noopener noreferrer" aria-label="Open Google Colab" style="display: inline-block; background-color: #1a73e8; color: white; padding: 8px 16px; border-radius: 4px; text-decoration: none; font-weight: 500; font-size: 13px;">
