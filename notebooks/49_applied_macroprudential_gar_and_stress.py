...
ax1.plot(dates, merged["gdp_growth"].shift(-4), color=_nbstyle.TEXTO, lw=1.0, ls="--", label="Realized $y_{t+4}$")
...
ax3.axhline(tot_s.mean(), color=_nbstyle.SPINE, lw=1.0, ls="--", label=f"Sample Mean ({tot_s.mean():.1f}%)")
