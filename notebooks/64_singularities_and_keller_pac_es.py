...
# %% [markdown]
# # Singularidades y continuación de Keller: ejemplos numéricos
#
# **Cómo diagnosticamos un equilibrio difícil sin afirmar un pliegue económico no verificado?**
#
# Inspeccionamos una tabla insumo-producto de la OCDE incluida en el paquete, un pliegue escalar escrito a mano, una calibración CGE sintética pequeña y una matriz deliberadamente mal condicionada. Son experimentos distintos. sigma=0.1238 es una calibración elegida, no un umbral de bifurcación demostrado.
#
# ## El método en matemáticas
#
# La continuación de Keller amplía $F(x,\lambda)=0$ con una restricción tangente y resuelve un sistema bordeado. Para una matriz de insumos no negativa, una cota espectral superior menor que uno certifica productividad; un intervalo que cruza uno es inconcluso. Los residuos pequeños solo certifican las ecuaciones especificadas.
#
# ## Intuición
#
# **Intuición.** Permitir cambios en el estado y el parámetro de continuación puede ayudar a seguir una rama que gira. Un pliegue didáctico demuestra la idea numérica, no un pliegue económico. El solucionador público usa un corrector denso; PAC condensado no está disponible. El ejemplo etiquetado Chipre introduce artificialmente una coordenada rígida y no estima un sistema salarial nacional.

# %% [markdown]
# ## Código resuelto — Continuación Numérica y Estabilización de Microeconomías
...
#
# Lea las cotas espectrales, los residuos y los tiempos de esta ejecución.
# Un intervalo espectral que cruza uno es inconcluso y no certifica viabilidad.
# El pliegue escalar usa un residuo didáctico escrito a mano. El ejemplo de PAC
# público usa un corrector denso en otra calibración sintética pequeña.
# La matriz de 77 dimensiones etiquetada Chipre se construye deliberadamente
# mal condicionada; su estabilización no es evidencia empírica sobre Chipre
# ni un pliegue económico. El tiempo depende del entorno.
# La certificación de teoremas sigue sin estar disponible.
#
# %% [markdown]
# ## Tu turno
#
# Cambie la elasticidad y revise el residuo final de esta calibración.
...
#
# Los ejemplos no certifican pliegues económicos ni los teoremas suspendidos. Consulte docs/STRUCTURAL_VALIDATION_STATUS.md.
